...
- moving comrade ahoy function to main functions file
...
- removed "Powered by Wordpress & Comrade" from footer, because let's face it: we all delete this anyway.
...
- removed default "Comrade" text in footer if you don't have a menu
...
- added comrade body class depending on what browser
...
- added post formats to comrade.php core
...
- fixed error in comrade.php for menu fallback **thanks Mark**
...
- moved the custom script call and pngfix to the footer
	from the comrade file so it's easier to see what's being
	called.
