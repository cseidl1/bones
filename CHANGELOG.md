...
- moving solidarity ahoy function to main functions file
...
- removed "Powered by Wordpress & Solidarity" from footer, because let's face it: we all delete this anyway.
...
- removed default "Solidarity" text in footer if you don't have a menu
...
- added solidarity body class depending on what browser
...
- added post formats to solidarity.php core
...
- fixed error in solidarity.php for menu fallback **thanks Mark**
...
- moved the custom script call and pngfix to the footer
	from the solidarity file so it's easier to see what's being
	called.
